...
:- include(percepts_type_KB).	% PERCEPTION handling and processing, and direct GETTERS from perception
:- include(percepts_process_KB).	% PERCEPTION handling and processing, and direct GETTERS from perception
...
% :- include(location_base).	% reasoning about LOCATIONS and DISTANCE
